...
void qmainstackwidget::set_layout_putton()
{
	...
	QIcon icon_people("./image/people.png");
	QIcon icon_message("./image/message");
	QIcon icon_other("./image/other");
...
void qmainstackwidget::set_editsearch()
{
	...
	search->setStyleSheet("QPushButton{ border-image:url(./image/search.png); }"
		"QPushButton:press{border-image:url(./image/search_press.png);}"
